...
const BlogPosts = () => {
    return <div className="blogPosts">
        <h1 className="blogPosts__title">Our Blog Posts</h1>
        <p className="blogPosts__text">We are an online plant shop offering a wide range of cheap and trendy plants. </p>
                ...
                blogData.map(item => (
                    <div className="blog__card" key={item.id}>
                        ...
                        <div className="blog__card__info">
                            <p className="blog__card__info__date">Septembet {item.date} | Read in {item.view} minutes</p>
